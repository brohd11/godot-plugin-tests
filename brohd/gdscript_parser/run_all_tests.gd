...
##         load("res://tests/brohd/gdscript_parser/run_all_tests.gd").run_all()   # -> String report
##         load("res://tests/brohd/gdscript_parser/run_all_tests.gd").run_tests() # -> {result, output}
...
const SUITES := [
	{"name": "Access Path",              "script": "res://tests/brohd/gdscript_parser/access_path_test.gd"},
	{"name": "Inference",                "script": "res://tests/brohd/gdscript_parser/inference_test.gd"},
	{"name": "Cross-Script Cache",       "script": "res://tests/brohd/gdscript_parser/cross_script_cache_test.gd"},
	{"name": "Serialization Round-Trip", "script": "res://tests/brohd/gdscript_parser/serialization_roundtrip_test.gd"},
	{"name": "Member Metadata",          "script": "res://tests/brohd/gdscript_parser/member_metadata_test.gd"},
	{"name": "Warmup",                   "script": "res://tests/brohd/gdscript_parser/warmup_test.gd"},
	{"name": "Declaring Script",         "script": "res://tests/brohd/gdscript_parser/declaring_script_test.gd"},
	{"name": "Global Enum",              "script": "res://tests/brohd/gdscript_parser/global_enum_test.gd"},
