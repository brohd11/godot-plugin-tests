...
func _init() -> void:
	var failures = 0
	for name in ["tag_registry", "struct", "optimizer", "inline", "expression_inline", "composition", "early_return", "expanded_inline", "template_inline", "struct_optimization", "struct_references"]:
